...
namespace HMT.IntegrationTests
{
    ...
    : WebApplicationFactory<Program>
    {
        ...
        private readonly string _connectionString = "Server=(localdb)\\mssqllocaldb;Database=MPCMechanicsTool-Test;Trusted_Connection=True;MultipleActiveResultSets=true";
    }
}
